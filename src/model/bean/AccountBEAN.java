...
public class AccountBEAN {
	...
	public AccountBEAN(long idTaiKhoan, long idLoaiTaiKhoan, String taiKhoan, String matKhau, String hoTen,
			String soDienThoai, String diaChi, String email, int diemTichLuy) {
		super();
		this.idTaiKhoan = idTaiKhoan;
		this.idLoaiTaiKhoan = idLoaiTaiKhoan;
		this.taiKhoan = taiKhoan;
