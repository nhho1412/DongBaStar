...
public class ADFilmBEAN {
	...
	public ADFilmBEAN(long idPhim, String tenPhim, String thoiLuong, String moTaNgan, String daoDien, String dienVien,
			String hinhAnh1, String hinhAnh2, String hinhAnh3, String hinhAnh4, String video, String theLoai,
			Date ngayCongChieu, int gioiHanTuoi, String dinhDangPhim, boolean trangThai) {
		super();
		this.idPhim = idPhim;
		this.tenPhim = tenPhim;
		this.thoiLuong = thoiLuong;
